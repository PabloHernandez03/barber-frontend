...
import aaronProfile from "../img/aaron_300.webp";
import aaronBackground from "../img/aaron_1200.webp";

const galleryModules = import.meta.glob("../img/aaron/*.{png,jpg,jpeg,svg,webp}", {
  eager: true,
  import: "default",
});
    ...
    <div className="container-fluid bg-dark text-white py-1">
      ...
      <div className="container mb-2 mt-4">
        <div
          ...
          style={{
            textAlign: "center",
            backgroundImage: `url(${aaronBackground})`,
        ...
        >
          ...
          <div className="mt-3">
            <a href="https://wa.me/5213330726408" target="_blank" rel="noopener noreferrer" className="text-white mx-2">
