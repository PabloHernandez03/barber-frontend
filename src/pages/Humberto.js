...
const galleryModules = import.meta.glob("../img/humberto/*.{png,jpg,jpeg,svg,webp,avif}", {
  eager: true,
  import: "default",
});
    ...
    <div className="container-fluid bg-dark text-white py-1">
      ...
      <div className="container my-5 mb-2 mt-4">
        <div
          ...
          style={{
            textAlign: "center",
            backgroundImage: `url(${humbertoImage})`,
        ...
        >
          ...
          <div className="mt-3">
            <a href="https://wa.me/5213328115400" target="_blank" rel="noopener noreferrer" className="text-white mx-2">
